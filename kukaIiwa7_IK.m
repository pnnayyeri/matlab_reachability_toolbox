function qOpts = kukaIiwa7_IK(eeTform, enforceJointLimits, sortByDistance, referenceConfig)
%kukaIiwa7_IK Function for generating closed-form inverse kinematics solutions to the DH robot given by the parameters specified below
%   $Revision: $ $Date: $
%
%   Generated on 10-Jun-2023 00:41:07


dhParams = [4.3432852493145e-14 -1.57079632679 -1.02828366063082e-12 0;-2.52435489670724e-29 1.57079632679 0.4 0;2.12691288870496e-25 -1.57079632679979 1.02828366063082e-12 0;-4.26407833776489e-31 1.57079632679 0.400000000000297 0;8.20092224003073e-26 -1.57079632679979 3.96623697671886e-13 0;0 1.57079632679 0.126 0];
thetaOffsets = [0 3.14159265358979 0 3.14159265358979 0 1.5707963267949];
lastThreeAxesSign = [1 -1 1];
jointLimits = [-2.09439510239 2.09439510239;-2.96705972839 2.96705972839;-2.09439510239 2.09439510239;-2.96705972839 2.96705972839;-2.09439510239 2.09439510239;-3.05432619099 3.05432619099];
...
baseToWorldTform = [-1 -2.06823107110214e-13 0 0;1.01272772229681e-24 -4.89658886014675e-12 1 -0.19;-2.06823107110214e-13 1 4.89658886014675e-12 -9.30351883427882e-13;0 0 0 1];
...
eeToJt5 = [1 0 0 -8.20099797067764e-26;0 1 -9.79327730021851e-12 -0.126;0 9.79327730021851e-12 1 -1.01359389405038e-12;0 0 0 1];
